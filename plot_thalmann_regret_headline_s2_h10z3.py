...
PLOT_DIR = "plots_thalmann_s2_h10z3" + os.environ.get("S2_RUN_SUFFIX", "")
...
REG_LEGEND_LABELS = {
    ...
    "R3": "marginalization over environments",
}
...
reg_handles = [Patch(facecolor="#444444", edgecolor="black",
                     alpha=REG_ALPHA[r], label=REG_LEGEND_LABELS[r])
               for r in ["R1", "R2", "R3"]]
...
ax.add_artist(leg1)
ax.legend(handles=reg_handles, loc="lower left",
          frameon=False, fontsize=9,
