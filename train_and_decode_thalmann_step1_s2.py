...
OUT_DIR           = f"plots_thalmann_s2{RUN_SUFFIX}/step1_vs_vanilla"
CKPT_DIR          = f"runs_thalmann_s2_step1_vs_vanilla{RUN_SUFFIX}"

# Match S1-only pipeline HP (train_and_decode_thalmann_step1.py).
Z_DIM             = 10
HIDDEN            = 3
TASK_EMB_DIM      = 2
A                 = 4
